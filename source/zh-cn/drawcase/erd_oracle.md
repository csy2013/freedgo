...
[Freedgo Desgin](https://www.freedgo.com)是一款轻松、快速、协作地创建各种专业图表工具。让您在线创建流程图、系统部署图、软件架构图、UML、BPMN、ER模型,DFD,组织图,软件流程图,图表。免费试用。使用Freedgo Design创建数据库ER模型目前支持Oracle及基本的SQL语句建表。 `Oracle`,等等数据库模型建模，支持SQL导入生成ER模型,通过DDL语句生成ER模型,ER模型SQL导出,根据ER模型生成SQL。
...
[在线制图 Oracle ER模型例子](https://www.freedgo.com/showcase/EntityRelationshipDiagram/Oracle-1.html "在线制图 Oracle ER模型例子") 

![在线制图_Oracle_ER模型](/public/themes/freedgo/er/oracle/er_oracle1.png "在线制图 Oracle ER模型")
